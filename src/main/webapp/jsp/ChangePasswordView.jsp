...
<input type="password" name="oldPassword" size=30 placeholder="Old Password is required" value=<%=DataUtility.getString(request.getParameter("oldPassword") == null ? "" : DataUtility.getString(request.getParameter("oldPassword")))%>></td>
